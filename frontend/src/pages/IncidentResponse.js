    ...
    function generateAiBriefing() {
      ...
      const text = [
        ...
        aiProvider.mode === 'provider'
          ? `Generated by SPARK AI provider: ${aiProvider.provider}.`
      ...
      return h('div', {className: 'card ai-briefing-card'},
        h('div', {className: 'ch'},
          h('div', null,
            ...
            h('div', {className: 'cs'}, `Generated ${briefing.generatedAt.toLocaleTimeString('pt-BR', {hour12: false, timeZone: 'America/Sao_Paulo'})} BRT · ${aiProvider.mode === 'provider' ? `${aiProvider.provider} connector configured` : 'deterministic fallback active'}`)
          ),
